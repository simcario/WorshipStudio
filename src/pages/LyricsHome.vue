<template>
  <q-page class="flex">
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 18]">
      <q-fab glossy icon="fas fa-bars" color="primary" direction="up">
    ...
    <ChordViewer v-if="mode=== 'chords'" :show="ChordViewer" />
    <TextViewer v-if="mode=== 'text'" :show="ChordViewer" />
    <QCode :qrcode="showQCode" />
    <div class="row full-width q-pa-md">
      <div class="col-6 q-pa-md">
        <q-card>
          <q-toolbar class="bg-green glossy text-white">
      ...
      <div class="col-6 q-pa-md">
        <q-tabs v-model="activeTab" class="bg-green text-white shadow-2 glossy">
                ...
                <q-list bordered>
                  ...
                  >
                    ...
                    >
                      ...
                      <q-item-section>
                        <div>
                          <q-badge color="green" text-color="white" :floating="false" :label="index+1" />
                          {{song.title}}
                        </div>
                      </q-item-section>
                      <q-item-label caption>{{song.author}}</q-item-label>
...
export default {
  ...
  sockets: {
    playlist_data: function(data) {
      this.playlist = data;
      this.currentPlaylistTitle = data.title;
    },
    playlist_song: function(data) {
      this.$root.$emit("song", data);
